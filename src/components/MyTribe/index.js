  ...
  return (
    <main className="myTribe">
      ...
      <section className="row justify-content-around">
        <div className="myTribe__members col-10 ">
        ...
        <div className="myTribe__shoppingList col-10 ">
      ...
      <section className="row justify-content-around">
        <div className="myTribe__activities col-10 ">
        ...
        <div className="myTribe__remembers col-10 ">
