  ...
  return (
    <div className="container text-center main">
      ...
      <div className="row justify-content-around p-2 ">
        <div className="card col-10 col-lg-5 m-2 p-1 ">
          <img src={activityImage} className="card-img-top" alt="canoë-kayak" />
          <div className="card-body text-center">
            <a href="/Activity" className="btn-sm btn-primary">Créez une activité</a>
        ...
        <div className="card col-10 col-lg-5 m-2 p-1">
          ...
          <div className="card-body text-center">
            <a href="/Shopping" className="btn-sm btn-primary">Créez une liste de shopping</a>
      ...
      <div className="row justify-content-around px-2">
        <div className="card col-10 col-lg-5 m-2  p-1">
          ...
          <div className="card-body text-center">
            <a href="/Remember" className="btn-sm btn-primary">Créez un souvenir</a>
        ...
        <div className="card col-10 col-lg-5 m-2 p-1">
          ...
          <div className="card-body text-center">
            <a href="/Tribe" className="btn-sm btn-primary">Créez une tribu</a>
